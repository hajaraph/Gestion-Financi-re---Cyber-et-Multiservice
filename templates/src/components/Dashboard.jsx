  ...
  return (
    <div className={`bg-white dark:bg-gray-800 rounded-2xl shadow-md p-4 sm:p-5 xl:p-6 border-l-4 ${styles.border} transform hover:scale-105 transition-transform duration-300`}>
      <div className="flex items-center justify-between">
        ...
        <div className={`w-12 h-12 ${styles.bg} ${styles.darkBg} rounded-2xl flex items-center justify-center`}>
          {icon}
        </div>
      </div>
    </div>
...
const RecentActivity = ({ activity }) => (
  <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-2xl">
